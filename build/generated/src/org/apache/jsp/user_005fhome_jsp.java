...
public final class user_005fhome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<div id=\"break-inverse\"><br></div>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group date \" id=\"start\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" Placeholder=\"Date due\"/>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" Placeholder=\"Add friends...\" id=\"addedfriend\">\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\tstring = \"<div id='here\"+i+\"' onClick='removeFriend(this)' >\"+name+\"&nbsp;<span class='glyphicon glyphicon-remove'></span><br></div>\"\n");
      ...
      out.write("\t\t//$(\"#lfirstname\").hide();\n");
      out.write("\t\t\t//$(\"#llastname\").hide();\n");
      out.write("\t\t\t    //$(\"#lemail\").hide();\n");
      out.write("\t\t\t\t\t//$(\"#lemail1\").hide();\n");
      out.write("\t});\n");
      ...
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#lfirstname\").fadeIn(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  else\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#lfirstname\").fadeOut(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  \n");
      out.write("\t\t\t  if(lastname==\"\")\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t   $(\"#llastname\").fadeIn(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  else\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#llastname\").fadeOut(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  if(email==\"\")\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t   $(\"#lemail\").fadeIn(500);\n");
      out.write("\t\t\t\t   flag1=1;\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  else\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#lemail\").fadeOut(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  if((!email.match(/^[_a-z0-9-]+(\\.[_a-z0-9-]+)*@[a-z0-9-]+(\\.[a-z0-9-]+)*(\\.[a-z]{2,4})$/))&&flag1==0)\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#lemail1\").fadeIn(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  if((email.match(/^[_a-z0-9-]+(\\.[_a-z0-9-]+)*@[a-z0-9-]+(\\.[a-z0-9-]+)*(\\.[a-z]{2,4})$/))&&flag1==0)\n");
      out.write("\t\t\t  {\n");
      out.write("\t\t\t\t  $(\"#lemail1\").fadeOut(500);\n");
      out.write("\t\t\t  }\n");
      out.write("\t\t\t  });\n");
      out.write("\t\t\t  \n");
      out.write("\t\t\t  \n");
